...
- Mehrere Instanzen, StdDev: Der Messwertpuffer für die Netz-Standardabweichung lag bei der jeweiligen Instanz. Wechselte der Gruppen-Leader, etwa weil eine Instanz die Regelung abschaltete, begann der neue Leader mit seinem eigenen, leeren oder veralteten Puffer, und die dynamischen Offsets sprangen. Der Puffer gehört jetzt der Netzgruppe und läuft beim Wechsel weiter. Der StdDev-Sensor zeigt in `sample_count` bei jeder Instanz die Anzahl der Werte in der Gruppe.
