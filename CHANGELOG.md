...
### Geändert
- README für die Aufnahme in den HACS-Standardstore überarbeitet ([hacs/default#9184](https://github.com/hacs/default/pull/9184))
- FAQ um den Betrieb ohne eigene Panels am Gerät erweitert, dazu Offset-Vorzeichen, getrennte AC-Regelstrecke und Ampere gegen Watt (Discussion [#31](https://github.com/D4nte85/Solakon-One-Nulleinspeisung-integration/discussions/31), [#30](https://github.com/D4nte85/Solakon-One-Nulleinspeisung-integration/discussions/30))
- Beschreibung des periodischen Triggers nennt jetzt auch den Fall der fehlenden Trigger-Quelle

### Behoben
- Regler blieb im gesättigten Zustand dauerhaft stumm — steht der Sollwert am oberen Limit und besteht der Netzfehler fort, wird nicht mehr geschrieben, ein stehengebliebener Wechselrichter bekommt keinen Befehl mehr. `_check_output_stall()` erkennt das über die Abweichung vom Limit und holt das Gerät über Fall D zurück ([#32](https://github.com/D4nte85/Solakon-One-Nulleinspeisung-integration/issues/32))
- `SurplusPowerSensor`: Docstring beschrieb den Wert falsch
